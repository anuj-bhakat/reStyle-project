  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-6 py-10">
        <h2 className="text-lg font-semibold text-gray-900 mb-6">Pending Sell Requests</h2>
            ...
            {pendingRequests.map((request) => (
              ...
              >
                ...
                <div className="flex flex-col p-4 flex-1">
                  ...
                  <p className="text-xs text-gray-600 line-clamp-2 mb-2">{request.description}</p>

                  {request.checklist_json && (
                    <div className="flex flex-wrap gap-1 text-[11px] text-gray-600 mb-3">
                      {Object.entries(request.checklist_json).map(([key, value]) => (
                        <span
                          key={key}
                  ...
                  <div className="flex items-center text-[12px] text-blue-700 font-medium mb-3">
